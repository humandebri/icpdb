  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6">
      <section className="max-w-xl rounded-2xl border border-line bg-paper p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-6 text-muted">Open the ICPDB console, or return to the start page.</p>
        <div className="mt-6 flex flex-wrap gap-2 text-sm">
          <Link className="rounded-lg bg-accent px-3 py-2 text-white no-underline" href="/">
            Open start page
          </Link>
          <Link className="rounded-lg border border-line bg-white px-3 py-2 text-ink no-underline" href="/icpdb">
            Open ICPDB
          </Link>
        </div>
      </section>
